      ...
      <el-tab-pane label="用户注册" name="signup">
        <el-form ref="form" :model="params" label-width="80px">
          <el-form-item label="昵称">
            <el-input placeholder="最大长度10位" type="email" :maxlength="10" v-model="params.name"></el-input>
          </el-form-item>
          <el-form-item label="邮箱">
            <el-input placeholder="用作登录使用" type="email" v-model="params.email"></el-input>
          </el-form-item>
          <el-form-item label="密码">
            <el-input type="password" placeholder="最大长度14位" :maxlength="14" v-model="params.password"></el-input>
          </el-form-item>
          <el-form-item label-width="40px">
